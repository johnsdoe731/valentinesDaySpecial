...
import videoFile from './assets/Karthi.mp4'
import './App.css'
    ...
    <div className="container">
      ...
      {noPressed ? (
        <div className="card success-container">
          <h1 className="success-title">Happy Valentine's Day💞</h1>
          <h3 className="subtext">My Love💞, My Life💖 and My Everything❤️</h3>
          <video
            ...
            playsInline
            src={videoFile}
            style={{ width: '400px', maxWidth: '70%', borderRadius: '16px', marginTop: '20px' }}
          >
        ...
        <div className="card">
          <h1 className="title">
            <span className="highlight">Dhakshinya💞,</span>
